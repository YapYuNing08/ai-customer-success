...
export function GridView(props: any) {
  const { filteredConsoleUsers, customerSearch, setCustomerSearch, filterPlan, setFilterPlan, filterRisk, setFilterRisk, setSelectedConsoleUser, setConsoleTab, setWorkspaceMode } = props;
  return (
                <>
